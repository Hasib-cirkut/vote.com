  ...
  return (
    <div id="body" className="grid grid-rows-2 h-full">
      ...
      <div className="space-y-10">
        <div
          className="btn_white h-11 transition hover:bg-green-300"
        ...
        {showBottomMsg && (
          <div
            className={`border rounded-sm px-4 py-2 text-xl font-md text-gray-300 text-center`}
          >
            <p>
              Request for {selected.name} has been accepted. You{`'`}ll be
              notified when your request is added to the main list. Thank you
              for you patience.
            </p>
          </div>
        )}
